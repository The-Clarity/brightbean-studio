...
if STORAGE_BACKEND.lower() == "s3":
    ...
    # Keep these unset for workload-identity deployments so boto3 uses its
    # default credential chain (EKS Pod Identity in Clarity). Static keys are
    # still supported for self-hosters that explicitly provide both values.
